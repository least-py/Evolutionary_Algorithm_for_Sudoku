...
public class Individual_1 {
	 ...
	 * 
	 * @param genom ein zweidimensionales Array gemäß dem Sudoku-Gitter. Der erste
	 *              Index entspricht der row. Der zweite Index entspricht der column
	 *              bzw. dem Element in der row.
	 */
	...
	/**
	 * Konstruktor zum Erzeugen eines Individuums mit zufälliger Initialisierung des
	 * Genoms. Es werden ausschließlich gültige Zeilen generiert.
	 * 
	...
	public Individual_1(int N) {
		...
		for (int row = 0; row < getN(); row++) {
			...
			// aus der Liste werden zufällig Zahlen ermittelt, die anschließend in das
			// Genomarray eingebaut werden
			for (int column = 0; column < N; column++) {
				// Erzeugt eine Zufallszahl zwischen 0 und liste.size() (liste.size()-1 größter
				// annehmbarer Wert, da immer abgerundet wird)
	 ...
	 * @param column entspricht der column bzw. der Stelle des Elements in der
	 *               gegebenen row
	 * @param gen    entspricht der Zahl, die in das Gitter eingefügt wird. Sie muss
	 *               größer als 0 und kleiner gleich N sein!
	 */
	...
	/**
	 * @return die Fitness eines Individuums, die sich aus den "Strafpunkten", die
	 *         hochgezählt werden, wenn eine der Sudokuregeln durch eine Zahl
	 *         verletzt wird, ergibt.
	 */
	...
	/**
	 * @return ein zweidimensionales Array, das die Elemente des Sudoku-Gitters
	 *         enthält. Der erste Index weist die Spalte zu. Der zweite Index weist
	 *         eine Spaltennumer zu, was wiederum einem Element der zuvor
	 *         zugewiesenen Zeile entspricht.
	 */
	...
	/**
	 * @return die Ähnlichkeit des Individuums zu einem Individuum der
	 *         Ausgangspopulation
	 */
	...
	/**
	 * @param similarity die Ähnlichkeit des Individuums zu einem Individuum der
	 *                   Ausgangspopulation
	 */
