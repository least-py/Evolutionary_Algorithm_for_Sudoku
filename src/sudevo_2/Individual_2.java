package sudevo_2;
	...
	public class Individual_2 {
		...
		/**
		 * Konstruktor zum Erzeugen eines Individuums. ! Das Individuum wird ohne Gültigkeit eines Teilbereichs wie bsw.
		 * den Zeilen erzeugt !
		 * @param N
		 */
		public Individual_2(int N) {
			this.N = N;
			this.setIdentification(Main_2.getID());
			Main_2.setID(Main_2.getID() + 1);
			int N_squared = N*N;
