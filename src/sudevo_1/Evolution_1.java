...
public class Evolution_1 {
	...
	/**
	 * Berechnet die Strafpunkte eines Individuums, die sich aus der Anzahl der Zahlen, die die Regeln verletzten ergibt.
	 * Betrachtet werden Spalten und Boxen, da die Zeilen korrekt initialisiert sind.
	...
	public static int calc_fitness(Individual_1 iv) {
		...
		//horizontale box, damit die vertikale Erstellabfolge horizontal verschoben werden kann
			...
			for(int vertical_box = 0; vertical_box < squrt; vertical_box++) {
				...
				for(int z = 0; z < squrt; z++) {
					for(int s = 0; s <  squrt ; s++) {
						//(z*squrt)+s sorgt dafür, dass die Elemente den richtigen Indices von 0 bis n-1 zugeordnet werden
	...
	/**
	 * Liefert eine bestimmte Anzahl an Individuen mit den besten Fitnesswerten aus einer Sammlung an Individuen.
	 * Die übergebenen Individuen bleiben unsortiert.
	...
	/**
	 * Selektiert Individuen durch zufällig gleichverteilte Auswahl an Individuen, von denen eine bestimmte Anzahl an Individuen 
	 * mit den besten Fitnesswerten ermittelt wird, 
	 * sodass prinzipiell auch schlechtere Individuen selektiert werden können.
	 * Die Methode simuliert <b>ein</b> Turnier!
	 * @param pop die Population
	 * @param enemies Anzahl an Gegnern in der engeren Auswahl
	 * @param amount_of_champs Anzahl an Individuen, die in der engeren Auswahl gewinnen
	 ...
	 * Es handelt sich um eine uniforme Selektion.
	 * @param pop die Population
	...
	/**
	 * Rekombiniert die jeweiligen Zeilen zweier Individuen, um ein neues Individuum zu schaffen. Durch cprob kann 
	 * man die Wahrscheinlichkeit der Übernahme einer Zeile des besseren Individuums steuern.
	 * @param iv_1 ein Individuum
	 * @param iv_2 ein anderes Individuum
	 * @param cprob die Wahrscheinlichkeit, mit der eine Zeile des besseren Individuums übernommen wird
	...
	/**
	 * Die Methode tauscht zwei Zahlen einer Zeile miteinander und erhält somit die Gültigkeit.
